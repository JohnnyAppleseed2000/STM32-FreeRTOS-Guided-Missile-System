...
typedef struct {
    float Kp, Ki, Kd;       // 제어 이득
    float target;           // 목표값 (예: 90도)
...
#define BASE_KP                   4.0f   // 기본 비례 게인 (실험 시작점)
#define BASE_KI                   0.5f    // 기본 적분 게인 (작게 시작)
#define BASE_KD                   0.5f    // 기본 미분 게인 (진동 억제용)

/* pid_logic.h */
#define PID_OUT_MIN               -1000.0f  // 1500에서 최대 500만큼 뺄 수 있음
#define PID_OUT_MAX               1000.0f  // 1500에서 최대 500만큼 더할 수 있음
